...
<div class="SelectMenu">
  ...
  <div data-view-component="true">          <ul class="dropdown-menu dropdown-menu-sw">
            ...
            <li>
              <clipboard-copy data-toggle-for="blob-more-options-details" aria-label="Copy path" value="assets/mail/contact_me.php" data-view-component="true" class="dropdown-item cursor-pointer">
...
<template class="js-line-alert-template">
  ...
  <table class="highlight tab-size js-file-line-container js-code-nav-container js-tagsearch-file" data-tab-size="8" data-paste-markdown-skip data-tagsearch-lang="PHP" data-tagsearch-path="assets/mail/contact_me.php">
        <tr>
        ...
        <tr>
          ...
          <td id="LC15" class="blob-code blob-code-inner js-file-line"><span class=pl-s1><span class=pl-c1>$</span>subject</span> = <span class=pl-s>&quot;Contato Através do Portifólio no GitHub:  $name&quot;</span>;</td>
        </tr>
        <tr>
          <td id="L16" class="blob-num js-line-number js-code-nav-line-number" data-line-number="16"></td>
          <td id="LC16" class="blob-code blob-code-inner js-file-line"><span class=pl-s1><span class=pl-c1>$</span>body</span> = <span class=pl-s>&quot;Você receber uma nova mensagem através do seu Portifólio no GitHub.\n\n&quot;</span>.<span class=pl-s>&quot;Veja os Detalhes:\n\Nome: $name\n\nEmail: $email\n\nTelefone: $phone\n\nMessagem:\n$message&quot;</span>;</td>
        </tr>
        <tr>
